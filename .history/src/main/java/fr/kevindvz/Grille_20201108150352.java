...
public class Grille {
    ...
    private void verifierGrille(HashMap<Integer, Pion> map, int tourDejeux) {
        ...
        this.etatGrille = map.get(1) == map.get(2)
                ? map.get(2).symbole == map.get(3).symbole ? ("Joueur " + tourDejeux + " gagnant ! Bravo !") : " en cours"
                : "en cours";
        this.etatGrille = map.get(1).symbole == map.get(4).symbole
                ? map.get(4).symbole == map.get(7).symbole ? ("Joueur " + tourDejeux + " gagnant ! Génial !") : " en cours"
                : "en cours";
        this.etatGrille = map.get(1).symbole == map.get(5).symbole
                ? map.get(5).symbole == map.get(9).symbole ? ("Joueur " + tourDejeux + " gagnant ! You're the greatest !") : " en cours"
                : "en cours";
        this.etatGrille = map.get(3).symbole == map.get(5).symbole
                ? map.get(5).symbole == map.get(7).symbole ? ("Joueur " + tourDejeux + " gagnant ! Extraordinary !") : " en cours"
                : "en cours";
        this.etatGrille = map.get(3).symbole == map.get(6).symbole
                ? map.get(6).symbole == map.get(9).symbole) ? ("Joueur " + tourDejeux + " gagnant ! Marvellous !") : " en cours"
                : "en cours";
        this.etatGrille = map.get(2).symbole == map.get(5).symbole
                ? map.get(5) == map.get(8) ? ("Joueur " + tourDejeux + " gagnant  OH YEAH !") : " en cours"
                : "en cours";
        this.etatGrille = map.get(7).symbole == map.get(8).symbole
                ? map.get(8).symbole == map.get(9).symbole ? ("Joueur " + tourDejeux + " gagnant ! You are the champion !")
                        : " en cours"
                : "en cours";
        this.etatGrille = map.get(4).symbole == map.get(5).symbole
                ? map.get(5).symbole == map.get(6).symbole ? ("Joueur " + tourDejeux + " gagnant ! Hop, un point de plus !")
                        : " en cours"
                : "en cours";
    ...
    public void fairePartie() {
        ...
        while (finDePartie == false) {
            ...
            while (this.etatGrille == "en cours") {
                ...
                System.out.println(map.get(1).symbole);
